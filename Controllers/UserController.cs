...
namespace FacilityManagement.Controllers
{
    public class UserController : Controller
    {
        ...
        public UserController(FacilityManagementContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var user = await _context.Users
                .Include(u => u.OwnedFacilities)
                .Include(u => u.OccupiedUnits)
                    .ThenInclude(su => su.Facility)
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Email,CreatedAt")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
