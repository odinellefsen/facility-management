        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeSquareMeters = table.Column<double>(type: "REAL", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StorageUnits_Facilities_FacilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StorageUnits_FacilityId_UnitNumber",
                table: "StorageUnits",
                columns: new[] { "FacilityId", "UnitNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_StorageUnits_OccupantId",
                table: "StorageUnits",
                column: "OccupantId");
